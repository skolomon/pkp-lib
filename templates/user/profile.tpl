...
{block name="page"}
	...
	<div id="profileTabs" class="pkp_controllers_tab">
		<ul>
			...
			<li><a name="agreement" href="{url router=\PKP\core\PKPApplication::ROUTE_COMPONENT component="tab.user.ProfileTabHandler" op="agreement"}">{translate key="dogovir.tab"}</a></li>
