...
class QueryAssignedToUserAccessPolicy extends AuthorizationPolicy
{
    ...
    public function effect()
    {
        ...
        $managerAssignments = array_intersect([Role::ROLE_ID_MANAGER, Role::ROLE_ID_SITE_ADMIN, Role::ROLE_ID_SUB_EDITOR/*skolomom: allow for moderator*/], $accessibleWorkflowStages[$query->getStageId()] ?? []);
